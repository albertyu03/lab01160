...
class scanner_t {
  ...
  private:
	...
	//vector for input, vector for char
...
void scanner_t::grab_tokens() {
	char cur_char = getchar();
	map<char, token_type> tokentl = {{'0', T_num}, {'1', T_num}, {'2', T_num}, {'3', T_num},
	 {'4', T_num}, {'5', T_num}, {'6', T_num}, {'7', T_num}, {'8', T_num}, {'9', T_num}, 
	 {'+', T_plus}, {'-', T_minus}, {'*', T_times}, {'.', T_period}, {'|', T_bar}, {'(', T_openparen}, 
	 {')', T_closeparen}};
	bool was_int = false;
	while(!cin.eof()) {
		if(!(cur_char == ' ' || cur_char == '\n')) {
			if(tokentl.count(cur_char) > 0) { //exists as map char
